...
from utils.auth_helper import create_access_token, create_refresh_token, get_current_user
...
def update_user(
    ...
    return crud_operations.update_user_info(db, user_id, user_update, current_user)
...
def delete_user(
    ...
    return crud_operations.delete_user_account(db, user_id, current_user)